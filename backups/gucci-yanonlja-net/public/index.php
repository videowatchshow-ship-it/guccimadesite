...
<body>
  ...
  <!-- 공통 헤더 (동적 로딩) -->
  <!-- 🏠 헤더 -->
  <header role="banner" style="background: linear-gradient(135deg, #071a2e, #0a2540); padding: 1rem 2rem; border-bottom: 2px solid rgba(245,200,66,0.2); margin-bottom: 1rem;">
    <nav style="max-width: 1200px; margin: 0 auto; display: flex; gap: 1.5rem; align-items: center; flex-wrap: wrap; font-family: 'SchoolSafetyTteokbokki', sans-serif;">
      <a href="/" style="font-size: 1.1rem; font-weight: bold; color: #f5c842; text-decoration: none; white-space: nowrap;">🏠 홈</a>
      <a href="/streaming/" style="color: #c8d8e8; text-decoration: none; white-space: nowrap; transition: color 0.2s;">🔴 스트리밍</a>
      <a href="/games/" style="color: #c8d8e8; text-decoration: none; white-space: nowrap; transition: color 0.2s;">🃏 게임</a>
      <a href="/free-board/" style="color: #c8d8e8; text-decoration: none; white-space: nowrap; transition: color 0.2s;">💬 게시판</a>
      <a href="/reservation/" style="color: #c8d8e8; text-decoration: none; white-space: nowrap; transition: color 0.2s;">📅 예약</a>
      <a href="/contact/" style="color: #c8d8e8; text-decoration: none; white-space: nowrap; transition: color 0.2s;">📞 연락</a>
    </nav>
  </header>
