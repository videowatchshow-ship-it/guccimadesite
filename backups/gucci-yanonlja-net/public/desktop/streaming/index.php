...
<main id="main-content" role="main">
  ...
  <!-- 페이지 헤더 -->
  <section class="d-page-hero" aria-label="스트리밍 페이지 헤더">
    <div class="d-inner"><h1 style="font-size:clamp(1.5rem,3vw,2.25rem);color:#fff;margin-bottom:.5rem;">
        <span style="color:#f5c842;">실시간</span> 스트리밍
        <span style="font-size:.75rem;background:rgba(229,62,62,.9);color:#fff;padding:.25rem .6rem;border-radius:4px;margin-left:.75rem;vertical-align:middle;">LIVE</span>
      </h1>
      <p style="color:#8898aa;font-size:1rem;">아바타 바카라 캄보디아 현장 생방송 · 고화질 · 저지연 · 전체화면 지원</p>
      <p style="font-size:.8rem;color:#4a5568;margin-top:.5rem;">단축키: <kbd class="d-kbd">Alt+S</kbd> 스트리밍 · <kbd class="d-kbd">F</kbd> 전체화면</p>
    </div>
  </section>
