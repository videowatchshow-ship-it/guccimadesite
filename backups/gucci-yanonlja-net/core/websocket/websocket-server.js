#!/usr/bin/env node
/**
 * 구찌야놀자 WebSocket 채팅 서버 v2.1.0
 * 정규식 검증 + 명령어 처리 + XSS 방지
 *
 * 공식 문서 출처:
  ...
  const tests = [
    {
      ...
      cases: [
        ...
        { input: 'test@domain.co.kr', expected: true },
      ]
    },
    {
      name: '닉네임 검증',
      ...
      cases: [
        { input: '구찌야놀자', expected: true },
        { input: 'user_123', expected: true },
        { input: 'a', expected: false },
        { input: '12345678901234567890123', expected: false },
      ]
    },
    {
      name: 'URL 검증',
    ...
    },
    {
      ...
      cases: [
        ...
        { input: '/nick 새닉네임', expected: true },
        { input: '/users', expected: true },
        { input: 'not a command', expected: false },
      ]
    }
  ];
