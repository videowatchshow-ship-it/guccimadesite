...
✅ VPS 서버: 76.13.218.129 (srv1636789.hstgr.cloud)  
✅ OS: Ubuntu 24.04 LTS  
✅ 사용자: root  
✅ 배포 스크립트: auto-deploy.sh  
...
2. VPS 메뉴 클릭
3. "srv1636789.hstgr.cloud" 서버 찾기
4. "Manage" 버튼 클릭
```

### Step 2: Browser Terminal 열기 (공식 권장 방법)
